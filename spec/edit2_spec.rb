...
describe 'Edit' do
  context 'cope with non-standard original filenames, ie not from LS-14' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'destination_folder' => "/Users/martinpick/Dropbox/sqbx/2019/2019_alberti", 'distinguisher' => "3", 'audio_file_name' => "non standard.mp3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Sue Clark, David Winder", 'album' => "Alberti", 'song' => "Sonata in D", 'opus' => "K381", 'comment_used_as_location' => "Thornbridge Hall", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Sue Clark, David Winder, Mozart, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018", 'TCOM' => "Mozart"}
