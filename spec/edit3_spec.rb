...
describe 'Edit' do
  context 'combine audio and video files' do
    before :each do
      ...
      @hash_version_of_data = {'video_file_name' => "MVI_2424_no3_rach.MP4", 'destination_folder' => "/Users/martinpick/Dropbox/sqbx/2019/2019_alberti", 'distinguisher' => "3", 'file_name' => "non standard.mp3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Sue Clark, David Winder", 'album' => "Alberti", 'song' => "Sonata in D", 'opus' => "K381", 'comment_used_as_location' => "Thornbridge Hall", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Sue Clark, David Winder, Mozart, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018", 'TCOM' => "Mozart"}
      @array_version_of_data = [["destination_folder", "distinguisher", "video_file_name", "file_name", "discard_before_hours", "discard_before_mins", "discard_before_seconds", "discard_before", "discard_after_hours", "discard_after_mins", "discard_after_seconds", "discard_after", "artist", "album", "song", "opus", "genre", "TYER", "TIT2", "TCOM"],["/Users/martinpick/Dropbox/sqbx/2019/2019_alberti", "3", "MVI_2424_no3_rach.MP4", "190917_0688.MP3", "0", "0", "0", "0", "0", "0", "0", "0", "Sue Clark, David Winder", "Alberti", "Sonata in D", "K381", "Thornbridge Hall", "32", "2018", "Sue Clark, David Winder, Mozart, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018", "Mozart"]]
    ...
    it 'copes with a non standard filename' do
      expect(@edit5_ffmpeg.calculated_filename).to eq('sue-clark-david-winder_3_k381_thornbridge-hall_.mp3')
    end 
  end
  context 'make the TIT2 field from other data. Also, make the output filename artist_opus_location_date' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'destination_folder' => "/Users/martinpick/Dropbox/sqbx/2019/2019_alberti", 'distinguisher' => "3", 'file_name' => "190917_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Sue Clark, David Winder", 'album' => "Alberti", 'song' => "Sonata in D", 'opus' => "K381", 'comment_used_as_location' => "Thornbridge Hall", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Sue Clark, David Winder, Mozart, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018", 'TCOM' => "Mozart"}
  ...
  context 'use absolute paths for original and resulting file, and quote the original path' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'destination_folder' => "/Users/martinpick/Dropbox/sqbx/2019/2019_alberti", 'distinguisher' => "3", 'file_name' => "180919_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Tara O'Rourke, Sue Clark, David Winder", 'album' => "Alberti", 'opus' => "BWV847", 'comment_used_as_location' => "14TTB", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Sue Clark, David Winder, J S Bach, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018"}
  ...
  context 'split by ffmpeg, and use distinguisher, and also use the comment field as a location' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'distinguisher' => "3", 'file_name' => "180919_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Tara O'Rourke, Sue Clark, David Winder", 'album' => "Alberti", 'opus' => "BWV847", 'comment_used_as_location' => "14TTB", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Sue Clark, David Winder, J S Bach, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018"}
  ...
  context 'split by ffmpeg with no discard_after values' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'file_name' => "180919_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "53", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0.53", 'discard_after' => "0", 'artist' => "Martin Pickersgill", 'album' => "Alberti", 'opus' => "BWV847", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Martin Pickersgill, J S Bach, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018"}
  ...
  context 'split by ffmpeg' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'file_name' => "180919_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "52", 'discard_after_hours' => "0", 'discard_after_minutes' => "5", 'discard_after_seconds' => "0", 'artist' => "Martin Pickersgill", 'album' => "Alberti", 'opus' => "BWV847", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Martin Pickersgill, J S Bach, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018", 'comment_used_as_location' => "Cross St Chapel"}
...
=begin
  ...
  xcontext 'split by ffmpeg with neither discard_before nor discard_after values 6 Nov 19 both these variables have been removed' do
    before :each do
      @tag_list = "genre,year,artist" 
      @hash_version_of_data = {'file_name' => "180919_0688.MP3", 'discard_before_hours' => "0", 'discard_before_minutes' => "0", 'discard_before_seconds' => "0", 'discard_after_hours' => "0", 'discard_after_minutes' => "0", 'discard_after_seconds' => "0", 'discard_before' => "0", 'discard_after' => "0", 'artist' => "Martin Pickersgill", 'album' => "Alberti", 'opus' => "BWV847", 'genre' => "32", 'TYER' => "2018", 'TIT2' => "Martin Pickersgill, J S Bach, Prelude in C Minor, Bk 1, Alberti, 19 Sept 2018"}
