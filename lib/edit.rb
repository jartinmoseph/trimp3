...
=begin
  #@file_duration = @audio_file_duration || @video_file_duration
  @audio_file_duration ? @file_duration = @audio_file_duration : @file_duration = @video_file_duration
  @file_duration = @audio_file_duration || @video_file_duration
  @file_duration = @audio_file_duration || @video_ffmpeg_duration
=end
